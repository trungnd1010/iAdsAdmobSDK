...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Trung Nguyễn/iAdsAdmobSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Trung Nguyễn' => 'trungnd@ikameglobal.com' }
  s.source           = { :git => 'https://github.com/Trung Nguyễn/iAdsAdmobSDK.git', :tag => s.version.to_s }
